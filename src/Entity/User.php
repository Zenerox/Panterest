...
class User implements UserInterface
{
     ...
     * @Assert\NotBlank(message="Please insert your firstname")
     */
    private $firstName;

    /**
     * @ORM\Column(type="string", length=255)
     * @Assert\NotBlank(message="Please insert your lastname")
     */
    private $lastName;

    /**
     * @ORM\Column(type="string", length=180, unique=true)
     * @Assert\NotBlank(message="Please insert your e-mail address")
     * @Assert\Email(message="Please insert a valid e-mail address")
     */
    private $email;
